...
type IdentityAuthenServiceClient interface {
	...
	VerifyForgotPassword(ctx context.Context, in *UpdatePasswordRequest, opts ...grpc.CallOption) (*MessageResponse, error)
...
func (c *identityAuthenServiceClient) VerifyForgotPassword(ctx context.Context, in *UpdatePasswordRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	out := new(MessageResponse)
...
type IdentityAuthenServiceServer interface {
	...
	VerifyForgotPassword(context.Context, *UpdatePasswordRequest) (*MessageResponse, error)
...
func (UnimplementedIdentityAuthenServiceServer) VerifyForgotPassword(context.Context, *UpdatePasswordRequest) (*MessageResponse, error) {
...
func _IdentityAuthenService_VerifyForgotPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityAuthenServiceServer).VerifyForgotPassword(ctx, req.(*UpdatePasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}

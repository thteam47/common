...
func RegisterIdentityAuthenServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IdentityAuthenServiceServer) error {
	...
	mux.Handle("POST", pattern_IdentityAuthenService_VerifyForgotPassword_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/identity_authen_api.IdentityAuthenService/VerifyForgotPassword", runtime.WithHTTPPathPattern("/v1/identity-authen-api/forgot_password/update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterIdentityAuthenServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IdentityAuthenServiceClient) error {
	...
	mux.Handle("POST", pattern_IdentityAuthenService_VerifyForgotPassword_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/identity_authen_api.IdentityAuthenService/VerifyForgotPassword", runtime.WithHTTPPathPattern("/v1/identity-authen-api/forgot_password/update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_IdentityAuthenService_VerifyForgotPassword_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "identity-authen-api", "forgot_password", "update"}, ""))
